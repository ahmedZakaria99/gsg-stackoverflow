    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                <svg class="mr-3" width="45px" height="45px" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px"
            ...
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                <svg class="mr-3" width="45px" height="45px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        ...
                        <g>
                            <path
                                d="m372.971 178.12h-191.128c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5h191.128c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5z"/>
                            <path
                                d="m372.971 210.319h-191.128c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5h191.128c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5z"/>
                            <path
                                d="m147.367 112.769c0 4.142 3.358 7.5 7.5 7.5h115.057c8.261 0 14.982-6.721 14.982-14.983v-26.768c0-8.261-6.721-14.982-14.982-14.982h-174.594c-8.261 0-14.982 6.721-14.982 14.982v26.769c0 8.262 6.721 14.983 14.982 14.983h24.451c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5l-24.433.017-.018-26.752 174.576-.018.018 26.751h-115.057c-4.142.001-7.5 3.359-7.5 7.501z"/>
                            <path
                                d="m426.043 333.057c-4.142 0-7.5 3.358-7.5 7.5v118.452c0 20.949-17.043 37.992-37.992 37.992h-300.284c-20.949 0-37.992-17.043-37.992-37.992v-406.017c0-20.949 17.043-37.992 37.992-37.992 241.684.205 228.307-.493 233.007.545v72.854c0 17.573 14.297 31.87 31.87 31.87h72.854c.349 1.579.545 3.202.545 4.858v64.141c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-64.141c0-9.973-3.883-19.349-10.935-26.4l-87.792-87.792c-7.051-7.052-16.427-10.935-26.4-10.935h-228.149c-29.22 0-52.992 23.772-52.992 52.992v406.017c0 29.22 23.772 52.992 52.992 52.992h300.285c29.22 0 52.992-23.772 52.992-52.992v-118.452c-.001-4.142-3.359-7.5-7.501-7.5zm-18.106-227.788h-62.793c-9.302 0-16.87-7.568-16.87-16.87v-62.793z"/>
                            <path
                                d="m144.824 183.421c0-7.687-6.253-13.94-13.94-13.94h-36.596c-7.687 0-13.94 6.253-13.94 13.94v36.596c0 7.687 6.253 13.94 13.94 13.94h36.596c7.687 0 13.94-6.253 13.94-13.94zm-15 35.536h-34.476v-34.476h34.476z"/>
                            <path
                                d="m144.824 276.748c0-7.687-6.253-13.94-13.94-13.94h-36.596c-7.687 0-13.94 6.253-13.94 13.94v36.596c0 7.687 6.253 13.94 13.94 13.94h36.596c7.687 0 13.94-6.253 13.94-13.94zm-15 35.536h-34.476v-34.476h34.476z"/>
                            <path
                                d="m130.884 356.135h-36.596c-7.687 0-13.94 6.253-13.94 13.94v36.596c0 7.687 6.253 13.94 13.94 13.94h36.596c7.687 0 13.94-6.253 13.94-13.94v-36.596c0-7.687-6.253-13.94-13.94-13.94zm-1.06 49.475h-34.476v-34.476h34.476z"/>
                            <path
                ...
                <div class="sidebar pb-45px position-sticky top-0">
                    <ul class="generic-list-item generic-list-item-highlight fs-15">
                        ...
                        <li class="lh-26 active"><a href="{{ route('questions.index') }}"><i
                                    class="la la-globe mr-1 text-black"></i>
                                Questions</a></li>
                        <li class="lh-26"><a href="tags-list.html"><i class="la la-tags mr-1 text-black"></i> Tags</a>
                        </li>
                        <li class="lh-26"><a href="user-list.html"><i class="la la-user mr-1 text-black"></i> Users</a>
                        </li>
                        <li class="lh-26"><a href="badges-list.html"><i class="la la-id-badge mr-1 text-black"></i>
                                Badges</a></li>
                        <li class="lh-26"><a href="category-list.html"><i class="la la-sort mr-1 text-black"></i>
                                Categories</a></li>
                        <li class="lh-26"><a href="job-list.html"><i class="la la-mouse mr-1 text-black"></i> Jobs</a>
                        </li>
                                ...
                                <div
                                    ...
                                    <div class="votes text-center votes-2">
                                        ...
                                        <div class="answer-block answered my-2">
                                            <span
                                                class="answer-counts d-block lh-20 fw-medium">{{ $question->answers->count() }}</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="sidebar-questions pt-3">
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.html">Using web3 to call precompile contract</a>
                                        </h5>
                                        <small class="meta">
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.html">Is it true while finding Time Complexity of
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.html">image picker and store them into firebase
                                                with flutter</a></h5>
                                        <small class="meta">
...
<section class="footer-area pt-80px position-relative">
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <p class="py-3 fs-15 lh-24">Exercitationem expedita id illum ipsum pariatur quia ratione sapiente
                        soluta totam voluptate!</p>
                    <div class="social-icon-box">
                        <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="#"
                           target="_blank" title="Follow on Facebook">
                            <svg focusable="false" class="svg-inline--fa fa-facebook-f fa-w-10" width="16px"
                                 height="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path fill="currentColor"
                                      d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
                            </svg>
                        </a>
                        <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="#"
                           target="_blank" title="Follow on Twitter">
                            <svg focusable="false" class="svg-inline--fa fa-twitter fa-w-16" width="16px" height="16px"
                        ...
                        <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="#"
                           target="_blank" title="Follow on Linkedin">
                            <svg focusable="false" class="svg-inline--fa fa-linkedin fa-w-14" width="16px" height="16px"
                        ...
                        <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="#"
                           target="_blank" title="Follow on Instagram">
                            <svg focusable="false" class="svg-inline--fa fa-instagram-square fa-w-14" width="16px"
                                 height="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="currentColor"
    ...
    <div class="container">
        <div class="row align-items-center pb-4 copyright-wrap">
            <div class="col-lg-6">
                <p class="copyright-desc copyright--desc fs-14">Copyright &copy; 2021 <a href="https://techydevs.com/">TechyDevs</a>
                    Inc.</p>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-6">
...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:20 GMT -->
</html>
