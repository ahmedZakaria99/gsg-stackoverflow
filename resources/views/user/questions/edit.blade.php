...
<section class="hero-area bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Edit a public question</h2>
                ...
                <div class="card card-item">
                    <form action="{{ route('questions.update',$question->id) }}" method="POST" class="card-body">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="title"
                                       ...
                                       value="{{ old('title',$question->original_title) }}">
                                @error('title')
                        ...
                        <div class="input-box">
                            ...
                            <p class="fs-13 pb-3 lh-20">Include all the information someone would need to answer your
                                question</p>
                            <div class="form-group">
                                <textarea class="form-control form--control user-text-editor" rows="10"
                                          cols="40" name="description">{{ $question->description }}</textarea>
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status-open"
                                               value="open"
                                               @if (old('status',$question->status) == 'open') checked @endif>
                                        <label class="form-check-label" for="status-open">
                                            Open
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status-close"
                                               value="close"
                                               @if (old('status',$question->status) == 'close') checked @endif>
                                        <label class="form-check-label" for="status-close">
                                            Close
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="input-box pt-2">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox fs-13">
                                    ...
                                    <label class="custom-control-label custom--control-label" for="youAgreeCheckBox">By
                                        asking your question, you agree to the <a href="privacy-policy.html"
                                                                                  class="text-color hover-underline">Privacy
                                            Policy.</a></label>
                                </div>
                            </div>
                            <div class="btn-box">
                                <button type="submit" class="btn theme-btn">Update your question</button>
                            </div>
                        </div>
                    </form>
                </div><!-- end card -->
