        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-item">
                    <form action="{{ route('questions.store') }}" method="post" class="card-body" id="form">
                        @csrf
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <p class="fs-13 pb-3 lh-20">Include all the information someone would need to answer your
                                question</p>
                            <div class="form-group">
                                <textarea form="form" class="form-control form--control user-text-editor" rows="10"
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status-open"
                                               value="open"
                                               @if (old('status') == 'open') checked @endif>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status-close"
                                               value="close"
                                               @if (old('status') == 'close') checked @endif>
