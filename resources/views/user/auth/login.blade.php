...
@section('content')
    ...
    <section class="login-area pt-80px pb-80px position-relative">
        ...
        <div class="container">
                ...
                <div class="card-body row p-0">
                    <div class="col-lg-6">
                        <div
                            ...
                            <img src="{{ asset('assets/front/images/undraw-remotely.svg') }}" alt="Image" class="img-fluid">
                        </div>
                    </div><!-- end col-lg-6 -->
                                ...
                                <button
                                    ...
                                    <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
                                                                ...
                                                                viewBox="0 0 488 512"><path fill="currentColor"
                                                                                            d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg></span>
            ...
            <p class="text-black text-center fs-15">Don't have an account? <a href="{{ route('register') }}"
                                                                              class="text-color hover-underline">Sign
                    up</a></p>
        </div><!-- end container -->
    </section>
